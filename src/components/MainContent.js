...
//     return (
//       <span
//         className="inline-block bg-white text-customblue border border-customblue rounded-full text-sm font-semibold mx-2 my-1 relative"
//         style={{
//           paddingTop: "6px",
//           paddingBottom: "6px",
//           paddingLeft: "12px",
//           paddingRight: "30px", // Adjusted for the delete icon
//         }}
...
//           <button
//             className="absolute top-0 right-0 h-full px-2 text-red-600"
...
//             type="text"
//             value={skills[index]}
//             className="absolute inset-0 w-full bg-white text-customblue border border-customblue rounded-full text-sm font-semibold px-2"
//             style={{
//               zIndex: "-1",
//               paddingTop: "6px",
//               paddingBottom: "6px",
